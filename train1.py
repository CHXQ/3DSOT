...
from models.my_model1 import MyModel
...
def parse_config():
    ...
    parser.add_argument('--check_val_every_n_epoch', type=int, default=10, help='check_val_every_n_epoch')
    ...
    parser.add_argument('--log_dir', type=str, default="lightning_logs/debug", help='log location')
...
if not cfg.test:
    ...
    data_root = '/home/zhangxq/3DSOT/data'
    ...
    # val_ann_file = os.path.join(data_root, 'nuscenes_track_car_val.pkl')
    val_ann_file = os.path.join(data_root, 'nuscenes_track_car_val_extract.pkl')
