...
from nusenes_trace_dataset import NuscenceTraceDataset, TestTraceDataset
...
def parse_config():
    ...
    parser.add_argument('--log_dir', type=str, default="lightning_logs/0721", help='log location')
