...
class _PointnetSAModuleBase(nn.Module):
    def __init__(self, use_fps=True):
...
class PointnetSAModuleMSG(_PointnetSAModuleBase):
    ...
    def __init__(self, radii, nsamples, mlps, bn=True, use_xyz=False, use_fps=True, normalize_xyz=False):
...
class PointnetSAModule(PointnetSAModuleMSG):
    ...
    def __init__(
            self, mlp, radius=None, nsample=None, bn=True, use_xyz=False, use_fps=True, normalize_xyz=False
    ):
